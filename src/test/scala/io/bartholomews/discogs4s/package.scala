...
import fsclient.entities.AuthVersion
...
package object discogs4s {
  ...
  implicit val diffAccessTokenV1: Diff[AuthVersion.V1.AccessToken] =
      ...
      fromObject(
        ...
        DiffResultObject(
          ...
          fields = Map(
            ...
            "verifier" -> Diff[Option[String]].apply(left.verifier, right.verifier),
