...
trait ReleasesApi extends DiscogsEndpoint {
  private[api] val basePath: Uri = apiUri / "releases"
}
...
/**
  ...
  */
case class GetRelease(releaseId: Long, currency: Option[String]) extends ReleasesApi with JsonRequest.Get[Release] {
